...
from api.views.match.views import (
        game_settings,
        MatchCreationView,
        CreateOnlineMatchView,
        UserMatchListView,
...
from api.views.game.cli_views import (
        GameStateView,
        GameControlView,
        PlayerMoveView,
        GameStatsView
)
from api.views.tournament.views import (
        CreateTournamentView,
        AddMatchToTournamentView,
        AddWinnerToTournamentView,
        UserTournWinnerCountView,
        UserParticipationCountView,
        TournamentDetailView
)
from api.views.blockchain.views import (
        TournamentBlockchainScoresView,
        blockchain_score,
        blockchain_scores_bulk
)
...
urlpatterns = [
    ...
    path('blockchain/scores/bulk/',                             blockchain_scores_bulk, name='blockchain_scores_bulk'),
